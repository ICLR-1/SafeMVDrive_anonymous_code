...
**vlm-selector**: Get our GRPO-finetuned Qwen2.5 VL-Instruct-7B model from: [https://huggingface.co/Anonymous12315/SafeMVDrive/tree/main/vlm-selector/checkpoint-2600](https://huggingface.co/Anonymous12315/SafeMVDrive/tree/main/vlm-selector/checkpoint-2600).

**two-stage-simulator**: Get our diffusion-based trajectory generation model trained with one-frame context from from: [https://huggingface.co/Anonymous12315/SafeMVDrive/tree/main/two-stage-simulator](https://huggingface.co/Anonymous12315/SafeMVDrive/tree/main/two-stage-simulator).
...
We take [UniAD](https://github.com/OpenDriveLab/UniAD/) as an example. To evaluate it on the generated adversarial dataset, follow these steps:
